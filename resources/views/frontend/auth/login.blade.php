...
<head>
    ...
    <!--<script type="text/javascript" th:src="@{/static/js/example.js}"></script>-->
</head>
<body>
                    ...
                    <form id="form-login" action="/auth/login" method="post">
                        ...
                        <div class="form-group field-loginform-username required">
                            <div class="input-group">
                                <label class="input-group-addon"><i class="fas fa-user fa-fw"></i></label>
                                <input type="text" id="loginform-username" class="form-control"
                                       name="LoginForm[username]" placeholder="邮箱/用户名/已验证手机" autocomplete="off"
                                       tabindex="1" aria-required="true" aria-invalid="true">
                            </div>
                            <p class="help-block help-block-error"></p>
                        </div>
                        <div class="form-group field-loginform-password required">
                            <div class="input-group">
                                <label class="input-group-addon"><i class="fas fa-lock fa-fw"></i></label>
                                <input type="password" id="loginform-password" class="form-control"
                                       name="LoginForm[password]" placeholder="密码" autocomplete="off" tabindex="2"
                                       aria-required="true">
                            </div>
                            <p class="help-block help-block-error"></p>
                        </div>
                ...
                <div class="content-login-form-footer">
                    <div class="auth-clients">
                        <ul class="auth-clients">
                            <li>
                                <a class="qq auth-link" href="/auth/auth?authclient=qq" title="QQ"
                                   data-popup-width="860" data-popup-height="480">
                                    <span class="auth-icon qq"></span>
                                </a>
                            </li>
                            <li>
                                <a class="weixin auth-link" href="/auth/auth?authclient=weixin" title="WeiXin"
                                   data-popup-width="860" data-popup-height="480">
                                    <span class="auth-icon weixin"></span>
                                </a>
                            </li>
                            <li>
                                <a class="weibo auth-link" href="/auth/auth?authclient=weibo" title="WeiBo"
                                   data-popup-width="860" data-popup-height="480">
                                    <span class="auth-icon weibo"></span>
                                </a>
                            </li>
                            <li>
                                <a class="github auth-link" href="/auth/auth?authclient=github" title="GitHub"
                                   data-popup-width="860" data-popup-height="480">
                                    <span class="auth-icon github"></span>
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="link"><a href="/auth/register"><i class="icon-chevron-circle-right"></i>立即注册</a></div>
                </div>
            </div>
        </div>
    </div>
