...
<head>
    ...
    <title>@yield('title','eBestMall（鸿宇V8） - B2B2C商城系统')</title>
...
<div id="header">
    ...
    <div class="headerTop">
        <div class="w">
            ...
            <ul class="menuTop fr">
                @guest
                <li><div><a href="#login">您好，请登录</a></div></li>
                <li><div><a class="active" href="#register">免费注册</a></div></li><li class="spacer"></li>
                @else
                <li class="downTop">
                    <div>
                    ...
                    <div class="listTop">
                        <div><a href="javascript:;">账户管理</a></div>
                        <div><a href="#logout" data-method="post">安全退出</a></div>
                    </div>
    ...
    <div class="headerMain">
        <div class="w">
            <div class="logo">
                <h1><a href="/"><img src="/static/img/public/logo-e.png" alt="eBestMall" width="190" height="170"/> </a></h1>
            </div>
                ...
                <div class="header-search-cart-bar">
                    <div class="header-search-bar">
                        ...
                        <div class="header-hot-words">
                            <ul>
                                <li class="item"><a class="active" href="javascript:;" target="_blank">测试商品</a></li>
                ...
                <div class="item-body">
                    <div class="side-bar-body-no-login-wrap">
                        <div class="side-login-prompt">
                            ...
                            <p><a href="#login">您好，请登录</a>&nbsp;&nbsp;&nbsp;<a class="active" href="#register">免费注册</a></p>
                        </div>
                    </div>
                </div>
            </li>
...
<div id="footer">
    ...
    <div class="footer-info">
        <div class="w">
            ...
            <div class="footer-info-copyright">Copyright © 2015 - 2019  eBestMall <a href="http://www.hongyuvip.com/" target="_blank">鸿宇科技</a> 版权所有</div>
        </div>
    </div>
</div>
...
<div id="statisticsCode">
    <div class="statistics-code-content"></div>
</div>
