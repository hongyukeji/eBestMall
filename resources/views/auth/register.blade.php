...
@push('styles')
    <link href="{{ asset('statics/css/register.css') }}" rel="stylesheet">
@endpush

@push('scripts')
    <script src="{{ asset('statics/js/register.js') }}"></script>
@endpush
            ...
            <div class="w">
                <div class="content-register-from">
                    ...
                    <form id="form-register" action="/auth/register" method="post" autocomplete="off">
                        <input type="hidden" name="_csrf-frontend" value="7VUD8_6-z6q3xAnSR-P4UalVeZRXc7PaYEL3fvY3kJqlEGqehvua6-2DfpcRhbQomRE6-iRL4uwQcp4LqXXo-w==">
                        ...
                        <div class="form-item verify-code-item field-registerform-verify_code required">
                            ...
                            <div class="col-lg-5 verify-code-item-div"><input type="text" id="registerform-verify_code" name="RegisterForm[verify_code]" placeholder="请输入验证码" aria-required="true"></div><img id="captchaimg" src="/auth/captcha?v=5a8e7c2b7a4a5" alt="" title="换一换" style="cursor:pointer;float: right;margin: 3px;height: 44px;width: 100px;">
                    ...
                    <div class="content-register-from-link">
                        <div class="auth-clients-event">
                            <a href="javascript:;">
                                <img src="/statics/img/temp/temp-20180101115452_thumbnail.jpg">
                            </a>
                        </div>
