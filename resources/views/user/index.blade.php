...
@push('styles')
    <link href="{{ asset('statics/css/user.css') }}" rel="stylesheet">
@endpush

@push('scripts')
    <script src="{{ asset('statics/js/user.js') }}"></script>
@endpush
                    ...
                    <div class="member-main-item">
                        <div class="user-basic-info-wrap">
                            <div class="user-basic-info-avatar">
                                <a href="javascript:;">
                                    <img class="user-avatar member-shadow" src="http://q.qlogo.cn/qqapp/101446601/0680819C2A85205E3DB1959F6EA22E83/100" width="100" height="100">
                                </a>
                            </div>
                            <div class="user-basic-info">
                                <div class="user-basic-info-name">
                                    <a class="u-name" href="javascript:;">Shadow</a>
                                </div>
                                            ...
                                            <li class="item">
                                                <div>
                                                    <a href="javascript:;" title="商品标题">
                                                        <img src="/statics/img/public/bitmap/130x130.png" alt="" width="130" height="130">
                                                    </a>
