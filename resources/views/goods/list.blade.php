...
@push('styles')
    <link href="{{ asset('statics/css/list.css') }}" rel="stylesheet">
@endpush

@push('scripts')
    <script src="{{ asset('statics/js/list.js') }}"></script>
@endpush

@section('content')
    <ul class="breadcrumb"><li><a href="/">首页</a></li>
        <li><a href="#">全部结果</a></li>
        <li class="active">" 测试商品 "</li>
    </ul>
    ...
    <div class="goods-list">
        <div class="shop-wrap">
            <div class="shop-logo">
                <a href="javascript:;">
                    <img src="/statics/img/temp/tmps-brand-001.jpg" width="180" height="60">
                </a>
            </div>
            <div class="shop-main">
                ...
                <div class="shop-aside-content">
                    <ul>
                        <li class="shop-aside-content-item">
                            <div class="item-img">
                                <a href="javascript:;">
                                    <img src="/statics/img/temp/temp-42.jpg" width="160" height="160">
                                </a>
                            </div>
        ...
        <div class="shop-list-wrap">
            <div class="shop-list-filter">
                ...
                <div class="shop-list-filter-item transport-wrap">
                    ...
                    <div class="goods-feature-wrap">
                        <ul>
                            <li class="goods-feature-item"><a href="javascript:;"><span>☑</span>平台配送</a></li>
                            <li class="goods-feature-item"><a href="javascript:;"><span>☐</span>货到付款</a></li>
                            <li class="goods-feature-item"><a href="javascript:;"><span>☐</span>仅显示有货</a></li>
                        </ul>
                    </div>
            ...
            <div class="goods-list-wrap" data-key="测试商品">
                <ul>
                    <li class="goods-list-item">
                        <div class="goods-list-item-wrap">
                            <div class="goods-list-item-img">
                                <a href="/goods/index?id=1" target="_blank">
                                    <img src="/statics/img/temp/temp-goods_img_001.jpg" width="210" height="210">
                                </a>
                            ...
                            <div class="goods-list-item-price">
                                <strong><em>¥</em><i class="J-prom-p-18788675125">7999.99</i></strong>
                            </div>
                            <div class="goods-list-item-name">
                                <a href="/goods/index?id=1" title="苹果(Apple） iPhoneX Plus - 测试商品 - 平台自营" target="_blank">苹果(Apple） iPhoneX Plus - <em>测试商品</em> - 平台自营</a>
                            </div>
                            ...
                            <div class="goods-list-item-icons">
                                <div class="item-icons-wrap">
                                    ...
                                    <div class="item-icons-tips" style="display: none;">
                                ...
                                <div class="item-icons-wrap">
                                    ...
                                    <div class="item-icons-tips" style="top: 388px; display: none;">
                                        <span class="item-icons-triangle" style="left: 61px;"><i></i></span>
                                        <span class="item-icons">免邮</span>
                                        当前收货地址，本商品免邮费
                                    </div>
                                </div>
