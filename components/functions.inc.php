 ...
 *
 * @package		HongYu Framework
 * @author		HongYu Dev Team
 * @copyright	Copyright (c) 2011 - 2014, HongYu, Inc.
 * @license		http://www.hongyuvip.com/license/
 * @link		http://www.hongyuvip.com/
 * @since		Version 1.0
 * @filesource
 */
...
function show_error($exception_message, $error_message = '')
{
	...
	{
		AWS_APP::mail()->send('wecenter_report@outlook.com', '[' . G_VERSION . '][' . G_VERSION_BUILD . '][' . base_url() . ']' . $error_message, nl2br($exception_message), get_setting('site_name'), 'HongYu');
	}
