...
CREATE TABLE `ebm_goods` (
  ...
  `goodsDescribe` varchar(255) COLLATE utf8_unicode_ci DEFAULT '' COMMENT '商品描述',
  `goodsPrice` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '商品价格',
  `goodsMarketPrice` decimal(10,2) DEFAULT '0.00' COMMENT '商品市场价格',
  `goodsNumber` int(11) NOT NULL DEFAULT '0' COMMENT '商品数量',
  `goodsSalesVolume` int(11) DEFAULT '0' COMMENT '商品销量',
  `goodsCoverImage` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '商品封面图片',
  `goodsAllImage` text COLLATE utf8_unicode_ci COMMENT '商品所有图片',
  `goodsIntroduce` text COLLATE utf8_unicode_ci COMMENT '商品介绍',
  `goodsIsSale` enum('0','1') COLLATE utf8_unicode_ci DEFAULT '0' COMMENT '商品是否促销,0-否,1-是',
  `goodsIsHot` enum('0','1') COLLATE utf8_unicode_ci DEFAULT '0' COMMENT '商品是否热卖,0-否,1-是',
  `goodsSort` smallint(6) DEFAULT '100' COMMENT 'Sort值越大越靠前',
  `status` smallint(6) DEFAULT '0' COMMENT '状态:1-开启,0-关闭',
  `createdTime` int(11) DEFAULT NULL COMMENT '创建时间',
  `updatedTime` int(11) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`goodsId`)
...
INSERT INTO `ebm_migration` VALUES ('m170211_095215_order_detail', '1488778606');
...
INSERT INTO `ebm_migration` VALUES ('m170210_060151_goods', '1488780370');
