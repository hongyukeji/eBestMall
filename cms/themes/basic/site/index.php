...
<head>
    ...
    <link href='/static/home/fonts/fonts-googleapis.css' rel='stylesheet' type='text/css'>
    ...
    <div class="container">
        ...
        <nav class="navbar navbar-default">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= Yii::$app->homeUrl ?>">鸿宇科技</a>
            </div>
...
<section id="fh5co-home" data-section="home" style="background-image: url(/static/home/images/full_image_2.jpg);" data-stellar-background-ratio="0.5">
            ...
            <div class="text-inner">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <h2 class="to-animate">eBestMall是国内电子商务系统及服务解决方案新创品牌。为传统企业及创业者提供零售网店系统、网上商城系统、分销系统、B2B2C商城系统、微信分销系统、行业ERP等产品和解决方案。
...
<section id="fh5co-intro">
    <div class="container">
        <div class="row row-bottom-padded-lg">
            <div class="fh5co-block to-animate" style="background-image: url(/static/home/images/img_7.jpg);">
                <div class="overlay-darker"></div>
                <div class="overlay"></div>
                <div class="fh5co-text">
                    <i class="fh5co-intro-icon icon-bullhorn"></i>
                    <h2>eBestMall 最新动态</h2>
                    <p>eBestMall 基于Yii2.0企业级框架开发的B2B2C现代一体化电商平台系统。采用最前沿的Web技术和UI界面设计，彰显鸿宇团队的用心。电商创业之路，鸿宇愿陪您一起走过。</p>
                    <p><a href="http://www.ebestmall.com" class="btn btn-primary" target="_blank">More</a></p>
                </div>
            </div>
            <div class="fh5co-block to-animate" style="background-image: url(/static/home/images/img_8.jpg);">
                <div class="overlay-darker"></div>
                <div class="overlay"></div>
                <div class="fh5co-text">
                    <i class="fh5co-intro-icon icon-book"></i>
                    <h2>鸿宇论坛</h2>
                    <p>鸿宇自2015年11月18日起,至今已经为支持鸿宇的用户，稳定运营保驾护航<?= intval((time() - strtotime('2015-11-18')) / 86400) ?>天。共发布8次更新，修复90条BUG，用事实证明选择鸿宇是您最正确的决定。</p>
                    <p><a href="http://bbs.hongyuvip.com" class="btn btn-primary" target="_blank">Go to</a></p>
                </div>
            </div>
            <div class="fh5co-block to-animate" style="background-image: url(/static/home/images/img_10.jpg);">
                <div class="overlay-darker"></div>
                <div class="overlay"></div>
                <div class="fh5co-text">
                    ...
                    <p><a href="http://buy.hongyuvip.com" class="btn btn-primary" target="_blank">More</a></p>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row row-bottom-padded-sm">
            <div class="col-md-4 col-sm-6 col-xxs-12">
                <!--<a href="http://www.xiongmaolingshi.com" class="fh5co-project-item image-popup to-animate" target="_blank">-->
            ...
            <div class="col-md-4 col-sm-6 col-xxs-12">
                <a href="http://www.ipinkpuppy.com/" class="fh5co-project-item to-animate" target="_blank">
                    <img src="/uploads/images/temps/al-04.jpg" alt="Image" class="img-responsive">
                    <div class="fh5co-text">
                        <h2>PinkPuppy童装旗舰店</h2>
                        <span>采用 HongYuJD 系统</span>
                    </div>
                </a>
            </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box-testimony">
                    ...
                    <div class="author to-animate">
                        <figure><img src="/static/home/images/person1.jpg" alt="Person"></figure>
                        <p>
            ...
            <div class="col-md-4">
                <div class="box-testimony">
                    ...
                    <div class="author to-animate">
                        <figure><img src="/static/home/images/person2.jpg" alt="Person"></figure>
                        <p>
            ...
            <div class="col-md-4">
                <div class="box-testimony">
                    ...
                    <div class="author to-animate">
                        <figure><img src="/static/home/images/person3.jpg" alt="Person"></figure>
                        <p>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="fh5co-person text-center to-animate">
                    <figure><img src="/static/home/images/person1.jpg" alt="Image"></figure>
                    <h3>Spider</h3>
            ...
            <div class="col-md-4">
                <div class="fh5co-person text-center to-animate">
                    <figure><img src="/static/home/images/person2.jpg" alt="Image"></figure>
                    <h3>Shadow</h3>
            ...
            <div class="col-md-4">
                <div class="fh5co-person text-center to-animate">
                    <figure><img src="/static/home/images/person3.jpg" alt="Image"></figure>
                    <h3>Dream</h3>
...
<section id="fh5co-counters" style="background-image: url(/static/home/images/full_image_1.jpg);" data-stellar-background-ratio="0.5">
        ...
        <div class="row row-bottom-padded-md">
            <div class="col-md-6 to-animate">
                ...
                <ul class="fh5co-contact-info">
                    ...
                    <li><i class="icon-phone"></i>13952101395</li>
                    <li>
                        <i class="icon-qq"></i>
                        <a href="http://wpa.qq.com/msgrd?V=1&uin=1527200768&Menu=yes" target="_blank">1527200768</a>
                    </li>
...
<footer id="footer" role="contentinfo">
    <a href="#" class="gotop js-gotop" style="height: 75px;"><i class="icon-arrow-up2"></i></a>
    <div class="container">
        <div class="">
            <div class="col-md-12 text-center">
                <p>&copy; 2015-2017 <a href="http://www.hongyuvip.com/" target="_blank">eBestCMS</a> All Rights Reserved.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 text-center">
...
<script src="/static/home/js/magnific-popup-options.js"></script>
<!-- Google Map -->
<!--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCefOgb1ZWqYtj7raVSmN4PL2WkTrc-KyA&sensor=false"></script>-->
<!--<script src="/static/home/js/google_map.js"></script>-->
