...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="J_menuItem" href="/statics/css_animation.html"><i class="fa fa-magic"></i> <span class="nav-label">CSS动画</span></a>
                </li>
                <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <form role="search" class="navbar-form-custom" method="post" action="http://www.hongyuvip.com/theme/hplus/search_results.html">
        ...
        <div class="row J_mainContent" id="content-main">
            <!-- 初始访问URL -->
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?/*= Url::to(['/'.$this->context->id .'/'.$this->context->action->id]) */?>" frameborder="0" data-id="" seamless>
                321321
            </iframe>
        </div>
        <div class="footer">
            <div class="pull-right">&copy; 2015-<?= date('Y') ?> <a href="http://www.ebestmall.com/" target="_blank"><?= Html::encode(Yii::$app->name) ?></a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
