...
$this->registerCssFile('/static/css/register.css', ['depends' => 'app\assets\AppAsset']);
            ...
            <div class="content-register-from">
                ...
                <form id="form-register" action="/auth/register" method="post" autocomplete="off">
                    ...
                    <div class="form-item verify-code-item field-registerform-verify_code required">
                        ...
                        <div class="col-lg-5 verify-code-item-div"><input type="text" id="registerform-verify_code" name="RegisterForm[verify_code]" placeholder="请输入验证码" aria-required="true"></div><img id="captchaimg" src="/auth/captcha?v=5ac70fb01f592" alt="" title="换一换" style="cursor:pointer;float: right;margin: 3px;height: 44px;width: 100px;">
