...
$this->registerCssFile('/static/css/goods.css', ['depends' => 'app\assets\AppAsset']);
$this->registerJsFile('/static/js/goods.js',['depends' => 'app\assets\AppAsset']);

$this->title = '商品详情页 - eBestMall';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="goods-index">
    <!--<ul class="breadcrumb"><li><a href="/">首页</a></li>
        <li><a href="/category/index?id=2">手机 / 运营商 / 数码</a></li>
        <li><a href="/category/index?id=27">手机通讯</a></li>
        <li><a href="/category/index?id=163">手机</a></li>
                ...
                <div class="product-preview">
                    <div class="product-preview-main-img">
                        <div class="product-preview-main-img-box">
                            <div class="product-preview-main-img-box-magnifier" style="left: 200px; top: 0px; display: none;"></div>
                        ...
                        <div class="product-preview-main-img-big-box" style="display: none;">
                            <img src="/static/img/temp/temp-goods_img_002_big.jpg" alt="" style="left: 412px; top: 0px;">
                        </div>
                    </div>
                    ...
                    <div class="product-video-wrap">
                        ...
                        <video class="product-video-main" src="/static/uploads/temps/video-001.mp4" controls="controls" preload="auto" loop="loop" muted="muted" width="412" height="412">
                ...
                <div class="product-detail-content-wrap">
                    <div class="product-detail-content">
                        ...
                        <div class="product-detail-content-main">
                            ...
                            <p style="text-align:center;"><img src="/static/img/temp/temp-goods-img_content_20180306000520.jpg"></p>
                                ...
                                <div class="comment-0">
                                    <div class="comment-item">
                                        <div class="user-column">
                                            <div class="user-info"><img src="/static/img/public/user/user_default_avatar.jpg" width="25" height="25" alt="S***w" class="avatar">&nbsp;S***w
                                            </div>
