...
$this->registerCssFile('/static/css/list.css', ['depends' => 'app\assets\AppAsset']);
$this->registerJsFile('/static/js/list.js',['depends' => 'app\assets\AppAsset']);

$this->title = '商品搜索列表页 - eBestMall';
