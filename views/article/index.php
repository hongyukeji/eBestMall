...
$this->registerCssFile('/static/css/article.css', ['depends' => 'app\assets\AppAsset']);
$this->registerJsFile('/static/js/article.js',['depends' => 'app\assets\AppAsset']);

$this->title = '文章详情页 - eBestMall';
