...
class m170210_060200_order extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createTable(self::TABLE_NAME, [
            ...
            'shippingStatus' => $this->string()->defaultValue('')->comment('配送状态'),
            'status' => $this->smallInteger()->notNull()->defaultValue('0')->comment('订单状态:1-已完成,0-未完成'),
