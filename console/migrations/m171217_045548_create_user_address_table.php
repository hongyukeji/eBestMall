...
class m171217_045548_create_user_address_table extends Migration
{
    ...
    public function up()
    {
        ...
        $this->addForeignKey('fk-user_address-user_id-user-user_id', '{{%user_address}}', 'user_id', '{{%user}}', 'user_id', 'CASCADE', 'CASCADE');
    }
