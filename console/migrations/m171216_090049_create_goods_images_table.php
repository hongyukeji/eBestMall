...
class m171216_090049_create_goods_images_table extends Migration
{
    ...
    public function up()
    {
        ...
        $this->addForeignKey('fk-goods_images-goods_id-goods-goods_id', '{{%goods_images}}', 'goods_id', '{{%goods}}', 'goods_id', 'CASCADE', 'CASCADE');
        ...
        $this->batchInsert('{{%goods_images}}', [
            ...
            [
                '1',
                '/statics/img/temp/temp-goods_img_001_big.jpg',
                '/statics/img/temp/temp-goods_img_001.jpg',
                '/statics/img/temp/temp-goods_img_001_small.jpg',
                '/statics/img/temp/temp-goods_img_001.jpg',
                '100',
                '1',
                time(),
            ...
            [
                '1',
                '/statics/img/temp/temp-goods_img_002_big.jpg',
                '/statics/img/temp/temp-goods_img_002.jpg',
                '/statics/img/temp/temp-goods_img_002_small.jpg',
                '/statics/img/temp/temp-goods_img_002.jpg',
                '100',
                '1',
                time(),
