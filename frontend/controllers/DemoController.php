...
class DemoController extends Controller
{
    ...
    public function actionImages()
    {
        $data = [
            '0' => [
                'img' => '/statics/img/temp/temp-goods_img_001_big.jpg',
                'thumbnail' => '/statics/img/temp/temp-goods_img_001_small.jpg',
                'sort_order' => '100',
            ],
            '1' => [
                'img' => '/statics/img/temp/temp-goods_img_002_big.jpg',
                'thumbnail' => '/statics/img/temp/temp-goods_img_002_small.jpg',
                'sort_order' => '100',
            ],
            '2' => [
                'img' => '/statics/img/temp/temp-goods_img_001_big.jpg',
    ...
    public function actionValidate()
    {
        ...
        $model->addRule(['username'], 'trim')
            ...
            ->addRule(['username'], 'unique', ['targetClass' => '\common\models\UserModel', 'message' => Yii::t('app/error', 'This username has already been taken.')])
