...
$this->registerCssFile('/statics/css/user.css', ['depends' => frontend\assets\AppAsset::className()]);
$this->registerJsFile('/statics/js/user.js', ['depends' => frontend\assets\AppAsset::className()]);
                ...
                <div class="member-main-item">
                    <div class="user-basic-info-wrap">
                        <div class="user-basic-info-avatar">
                            <a href="javascript:;">
                                <img class="user-avatar member-shadow" src="<?= Yii::$app->user->identity->avatar_url ?: '/statics/img/public/bitmap/100x100.png'?>" width="100" height="100">
                            </a>
                        </div>
                                ...
                                <td class="order-img">
                                    <div>
                                        <a href="javascript:;" target="_blank" title="商品标题">
                                            <img src="/statics/img/public/bitmap/55x55.png" width="55" height="55">
                                        </a>
                                    </div>
                                </td>
                                        ...
                                        <li class="item">
                                            <div>
                                                <a href="javascript:;" title="商品标题">
                                                    <img src="/statics/img/public/bitmap/130x130.png" alt="" width="130"
                                                         height="130">
                                                </a>
                                        ...
                                        <li class="item">
                                            <div class="shop-wrap">
                                                <a class="shop-logo" href="javascript:;">
                                                    <img src="/statics/img/public/bitmap/100x100.png" width="100" height="100">
                                                </a>
                    ...
                    <div class="member-main-item-content">
                        <div class="user-browsing-history-wrap">
                            <ul>
                                <li>
                                    <div>
                                        <a href="javascript:;" title="商品标题"><img src="/statics/img/public/bitmap/55x55.png" width="55" height="55"></a>
