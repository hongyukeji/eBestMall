...
<div class="header-event" style="display: block;background-color: #f80a20;">
    <div class="w">
        <a class="header-event-bar" href="javascript:;" target="_self"><img src="/statics/img/temp/header-top.jpg" /> </a>
...
<div id="header">
    ...
    <div class="headerTop">
        <div class="w">
            ...
            <ul class="menuTop fr">
                ...
                <li class="downTop">
                    <div><a href="<?= Url::toRoute(['/seller']) ?>">卖家中心</a><div class="effectTop"><i class="icon-chevron-down"></i></div></div>
                    <div class="listTop">
    ...
    <div class="headerMain">
        <div class="w">
            <div class="logo">
                <h1><a href="<?= Yii::$app->homeUrl ?>"><img src="/statics/img/public/logo-e.png" alt="eBestMall" width="190" height="170"/> </a></h1>
            </div>
            ...
            <div class="header-main-right">
                                            ...
                                            <li class="item">
                                                <div class="goods-img">
                                                    <a href="javascript:;" target="_blank">
                                                        <img src="/statics/img/temp/temp-goods_img_001_small.jpg" width="50" height="50" alt="">
                                                    </a>
                                                </div>
                ...
                <div class="header-activity-bar"><a href="javascript:;"><img src="/statics/img/temp/activity.png" alt="新年红包抢不停"/></a></div>
            </div>
        </div>
    </div>
</div>
...
<div id="searchBar">
    <div class="w">
        <div class="searchBar-logo">
            <a href="<?= Yii::$app->homeUrl ?>"><img src="/statics/img/public/logo_small.png" alt=""></a>
        </div>
        ...
        <ul>
            <li class="item">
                <div class="item-btn">
                    ...
                    <?php else : ?>
                    <!--登陆后显示用户头像-->
                    <a href="javascript:;"><img src="<?= Yii::$app->user->identity->avatar_url ?: '/statics/img/public/user/no_login_default_avatar.jpg'?>" /></a>
                    <?php endif; ?>
                    <div class="item-title"><a href="javascript:;">会员中心<span>◆</span></a></div>
                </div>
                <div class="item-body">
                    ...
                    <div class="item-body-content">
                        <div class="sideBarContent-user-container">
                            <div class="sideBarContent-user-container-personal-info">
                                <div class="avatar">
                                    <a href="javascript:;"><img src="<?= Yii::$app->user->identity->avatar_url ?: '/statics/img/public/user/no_login_default_avatar.jpg'?>" alt=""></a>
                                </div>
                                <div class="user-info">
                                            ...
                                            <div class="sideBar-cartBar-goods-content-main">
                                                ...
                                                <div class="sideBar-cartBar-goods-content-main-img">
                                                    <a href="javascript:;" title="Apple/苹果 iPhone 7 Plus 32G 全网通4G智能手机">
                                                        <img src="/statics/img/temp/temp-goods_img_small_002.jpg" alt="Apple/苹果 iPhone 7 Plus 32G 全网通4G智能手机">
                                                    </a>
                                                </div>
...
<div id="footer">
    ...
    <div class="footer-info">
        <div class="w">
            ...
            <div class="footer-info-copyright">Copyright © 2015 - <?= date('Y') ?>  eBestMall-V<?= Yii::$app->version?> <a href="http://www.hongyuvip.com/" target="_blank">鸿宇科技</a> 版权所有</div>
        </div>
    </div>
</div>

<div id="statisticsCode">
    <div class="statistics-code-content"><?= Yii::$app->params['siteConfig']['statisticsCode'] ?></div>
</div>
