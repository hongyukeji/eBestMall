...
$this->registerCssFile('/statics/css/index.css', ['depends' => frontend\assets\AppAsset::className()]);
$this->registerJsFile('/statics/js/index.js',['depends' => frontend\assets\AppAsset::className()]);
            ...
            <div class="content-focus-right ">
                <div class="content-focus-right-user">
                    ...
                    <div class="content-focus-right-user-info_show">
                        ...
                        <?php else : ?>
                            <p>Hi，<?= Html::encode(Yii::$app->user->identity->nickname ?: Yii::$app->user->identity->username); ?></p>
                            <p>
                        ...
                        <li class="item">
                            <div class="item-wrap">
                                <div class="goods-info-wrap">
                                    ...
                                    <a href="<?= Url::to(["goods/index","id" => 1]) ?>" target="_blank"><img src="/statics/img/temp/temp-06.jpg" title="苹果(Apple） iPhone7 Plus - 测试商品 - 平台自营">
