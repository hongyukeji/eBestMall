...
$this->registerCssFile('/statics/css/register.css', ['depends' => AppAsset::className()]);
$this->registerJsFile('/statics/js/register.js', ['depends' => AppAsset::className()]);
...
<div class="site-signup">
    <div class="header-register">
        <div class="w">
            <div class="logo">
                <a href="<?= Yii::$app->homeUrl ?>"><img src="/statics/img/public/logo.png" alt=""></a>
