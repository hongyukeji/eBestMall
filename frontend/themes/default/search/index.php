...
$this->registerCssFile('/statics/css/list.css', ['depends' => frontend\assets\AppAsset::className()]);
$this->registerJsFile('/statics/js/list.js', ['depends' => frontend\assets\AppAsset::className()]);
