...
$this->registerCssFile('/statics/css/cart.css', ['depends' => frontend\assets\AppAsset::className()]);
$this->registerJsFile('/statics/js/cart.js',['depends' => frontend\assets\AppAsset::className()]);
                                    ...
                                    <div class="item goods">
                                        <div class="goods-item">
                                            <div class="goods-item-img">
                                                <a href="javascript:;"><img src="/statics/img/temp/temp-goods_002.jpg" width="100" height="100" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="goods-item">
