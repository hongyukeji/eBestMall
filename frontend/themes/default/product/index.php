 ...
 * 堂堂正正做人，踏踏实实做事。
 * ----------------------------------------------------------------------------
 * Author: Shadow  QQ: 1527200768  Time: 2017/7/7 16:24
        ...
        <div class="product-info-wrap">
            ...
            <div class="product-info-price-wrap">
                <div class="product-info-price-wrap-statistics">
                    ...
                    <div class="product-info-price-wrap-comment-count">
                        <p>累计销量</p>
                        <a class="notice" href="javascript:;"><?= $model['spu_sales_volume'] ?></a>
                    </div>
                </div>
                        ...
                        <li>
                            <a href="javascript:;" title="苹果iPhone7钢化膜 4.7英寸 3D碳纤维全屏全覆盖钢化玻璃膜 手机高清屏幕保护贴膜 黑色">
                                <div class="guess-you-like-content-up">
                                    <img src="<?= $baseUrl ?>/img/temp/temp-goods_img_small_0001.jpg" alt="">
                                    <p>¥198.00</p>
                                </div>
                        ...
                        <ul>
                            <li>
                                <a href="javascript:;" title="摩梵欧 苹果7手机壳指环支架 适用于iPhone7/7plus卡通浮雕保护软套 5.5英寸-巴黎塔">
                                    <div class="product-recommend-content-list-up">
                                        <img src="<?= $baseUrl ?>/img/temp/temp-goods_img_small_0003.jpg" alt="">
                            ...
                            <li>
                                <a href="javascript:;" title="摩梵欧 iPhone6S手机壳+钢化膜组合防摔硅胶浮雕保护套 适用于苹果6/6S/Plus 4.7英寸-水墨画">
                                    <div class="product-recommend-content-list-up">
                                        <img src="<?= $baseUrl ?>/img/temp/temp-goods_img_small_0005.jpg" alt="">
                            ...
                            <div class="comment-0">
                                <div class="comment-item" >
                                    <div class="user-column">
                                        <div class="user-info"><img src="<?= $baseUrl ?>/img/public/user/user_default_avatar.jpg" width="25" height="25" alt="S***w" class="avatar">&nbsp;S***w</div>
                                    ...
                                    <div class="comment-column">
                                        ...
                                        <div class="pic-list">
                                            <a href="javascript:;" ><img src="<?= $baseUrl ?>/img/temp/temp-goods_img_001_small.jpg" width="48" height="48" alt="S***w的晒单图片"></a>
                                            <a href="javascript:;"><img src="<?= $baseUrl ?>/img/temp/temp-goods_img_small_0001.jpg" width="48" height="48" alt="S***w的晒单图片"></a>
                                            <a href="javascript:;"><img src="<?= $baseUrl ?>/img/temp/temp-goods_img_small_0005.jpg" width="48" height="48" alt="S***w的晒单图片"></a>
                                            <a href="javascript:;"><img src="<?= $baseUrl ?>/img/temp/temp-goods_img_small_0003.jpg" width="48" height="48" alt="S***w的晒单图片"></a>
                                        </div>
