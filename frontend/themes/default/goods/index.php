...
$this->registerCssFile('/statics/css/goods.css', ['depends' => frontend\assets\AppAsset::className()]);
$this->registerJsFile('/statics/js/goods.js', ['depends' => frontend\assets\AppAsset::className()]);
                                ...
                                <div class="comment-item">
                                    <div class="user-column">
                                        <div class="user-info"><img
                                                    src="/statics/img/public/user/user_default_avatar.jpg" width="25"
                                    ...
                                    <div class="comment-column">
                                        ...
                                        <div class="pic-list">
                                            <a href="javascript:;"><img
                                                        src="/statics/img/temp/temp-goods_img_001_small.jpg" width="48"
                                                        height="48" alt="S***w的晒单图片"></a>
                                            <a href="javascript:;"><img
                                                        src="/statics/img/temp/temp-goods_img_small_0001.jpg" width="48"
                                                        height="48" alt="S***w的晒单图片"></a>
                                            <a href="javascript:;"><img
                                                        src="/statics/img/temp/temp-goods_img_small_0005.jpg" width="48"
                                                        height="48" alt="S***w的晒单图片"></a>
                                            <a href="javascript:;"><img
                                                        src="/statics/img/temp/temp-goods_img_small_0003.jpg" width="48"
                                                        height="48" alt="S***w的晒单图片"></a>
                                        </div>
