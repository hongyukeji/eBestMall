...
$this->registerCssFile('/static/css/cart.css', ['depends' => frontend\assets\AppAsset::className()]);
$this->registerJsFile('/static/js/cart.js',['depends' => frontend\assets\AppAsset::className()]);
