...
$this->registerCssFile('/static/css/index.css', ['depends' => frontend\assets\AppAsset::className()]);
$this->registerJsFile('/static/js/index.js',['depends' => frontend\assets\AppAsset::className()]);
