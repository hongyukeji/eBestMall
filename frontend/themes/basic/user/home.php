...
$this->registerCssFile('/static/css/user.css', ['depends' => frontend\assets\AppAsset::className()]);
//$this->registerJsFile('/static/js/user.js',['depends' => frontend\assets\AppAsset::className()]);
