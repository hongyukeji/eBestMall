...
$this->registerCssFile('/static/css/list.css', ['depends' => frontend\assets\AppAsset::className()]);
$this->registerJsFile('/static/js/list.js', ['depends' => frontend\assets\AppAsset::className()]);
