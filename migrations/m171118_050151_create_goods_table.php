...
class m171118_050151_create_goods_table extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createTable(self::TABLE_NAME, [
            ...
            'goods_cover_img' => $this->string()->notNull()->comment('商品封面图片'),
            'goods_cover_thumbnail' => $this->string()->notNull()->comment('商品封面缩略图'),
            'goods_images' => $this->text()->notNull()->comment('商品图片集'),
        ...
        $this->batchInsert('{{%goods}}', [
            ...
            [
                ...
                '[{"img":"\/static\/img\/temp\/temp-goods_img_001_big.jpg","thumbnail":"\/static\/img\/temp\/temp-goods_img_001_small.jpg","sort_order":"100"},{"img":"\/static\/img\/temp\/temp-goods_img_002_big.jpg","thumbnail":"\/static\/img\/temp\/temp-goods_img_002_small.jpg","sort_order":"100"},{"img":"\/static\/img\/temp\/temp-goods_img_001_big.jpg","thumbnail":"\/static\/img\/temp\/temp-goods_img_001_small.jpg","sort_order":"100"}]',
